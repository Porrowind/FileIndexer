...
public interface FileIndexer
{
     ...
     *
     * @param options Indexing parameters
     * @return {@link Document} if indexed
     * @throws FileIndexerException in case of any exception
     */
    Document get(FileIndexerOptions options) throws FileIndexerException;
     ...
     * Get index event bus
     *
     * @return {@link FileIndexerEventBus} if enabled, null - otherwise
     */
    FileIndexerEventBus getEventBus();
}
